                        ...
                        for(var j=0;j<graphNodes.length;j++){
                            if(parseInt(graphNodes[j]['viz_size'])==100){
                                if(graphEdges[i]['target']==graphNodes[j].id){
                                    ...
                                    var fromposy=getPos(graphNodes[j]['viz_position_y']);
                                    for(var k=0;k<graphNodes.length;k++){
                                        if(parseInt(graphNodes[k]['viz_size'])==52){
                                            if(graphEdges[i]['source']==graphNodes[k].id){
                                                ...
                                                var toposy=getPos(graphNodes[k]['viz_position_y']);
                                                //计算动点旋转角度
                                                ...
                                                makedd(fromposx,fromposy,toposx,toposy,ddArr[i],0,2000,2000);
                                            }
                                ...
                                if(graphEdges[i]['target']==graphNodes[j].id){
                                    ...
                                    for(var k=0;k<graphNodes.length;k++){
                                        if(graphEdges[i]['source']==graphNodes[k].id){
                                            ...
                                            makedd(fromposx,fromposy,toposx,toposy,ddArr[i],2000,2000,0);
                                        }
                                    }
                                }
                            }
